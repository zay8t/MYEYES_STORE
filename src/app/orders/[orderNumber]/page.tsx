...
export async function generateMetadata({
  ...
  return {
    title: `Order #${orderNumber} Tracking & Receipt | My Eyes`,
    description: `Track live payment verification, optical lab production, and receipt for Order #${orderNumber}.`,
  };
}
...
export default async function OrderTrackingPage({
  ...
  return <CustomerOrderTrackingView initialOrder={customerOrderData} isSuccessView={false} />;
}
