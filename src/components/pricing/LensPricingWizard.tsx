          ...
          <div className="p-6 sm:p-8 border-b border-neutral-100 bg-neutral-50/30">
            <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-neutral-500 font-normal mt-0.5">
                    Select the features you want for your lenses. Prices dynamically update based on mode.
                  </p>
                </div>
              </div>
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-neutral-200 bg-white text-[11px] font-semibold text-neutral-600 hover:text-amber-700 transition cursor-pointer"
              >
            ...
            <div className={cn("grid gap-3", isProgressive ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-4" : "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3")}>
              {activePackages.slice(0, isProgressive ? 4 : 3).map((pkg) => (
                <LensCard
                  key={pkg.id}
                  pkg={pkg}
                  selected={state.selectedLensId === pkg.id}
                  isProgressive={isProgressive}
                  onClick={() => set("selectedLensId", pkg.id)}
                />
              ))}
            </div>
