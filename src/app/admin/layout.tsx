      ...
      <div className="min-h-screen bg-slate-50/60 flex flex-col">
        ...
        <div className="flex-1 flex relative">
          ...
          <aside className="hidden lg:flex flex-col w-64 bg-white text-slate-900 fixed top-16 bottom-0 left-0 z-30 border-r border-slate-200/80 shadow-2xs">
            {/* Header Badge */}
            <div className="px-6 py-4.5 border-b border-slate-100 select-none">
              <h2 className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Admin Workspace</h2>
            </div>
